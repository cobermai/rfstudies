...
def _create_ok_data(created_tdms_files_dir: Path, created_hdf_files_dir: Path) -> None:
    ...
    tdms_creator.grp_prop_dict.update({"Log Type": 0})
    tdms_creator.add_artificial_group("LogGroupTest_ok_normallog")

    tdms_creator.grp_prop_dict.update({"Log Type": 1})
    tdms_creator.add_artificial_group("LogGroupTest_ok_bdin40ms")

    tdms_creator.grp_prop_dict.update({"Log Type": 2})
    tdms_creator.add_artificial_group("LogGroupTest_ok_bdin20ms")

    tdms_creator.grp_prop_dict.update({"Log Type": 3})
    tdms_creator.add_artificial_group("BreakdownGroupTest_ok_db")
