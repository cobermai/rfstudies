...
def get_tsfresh(data: dict, settings: dict, n_jobs: int = 0) -> pd.DataFrame:
    ...
    :param n_jobs: the number of cores used to calculate the features. Attention, for features that can be calculated
